...
const bioParagraphs = [
  ...
  "In 2026 my solo build was a prize winner at the AI Agent Olympics - the official builder event of Milan AI Week 2026, Europe's largest AI event (2,382 participants, 726 teams).",

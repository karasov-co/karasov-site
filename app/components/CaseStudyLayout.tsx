      ...
      <div className="max-w-5xl mx-auto px-6 py-16 md:py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16">
          ...
          <div className="flex flex-col gap-10">
            ...
            {/* Links out of the earlier portfolio pages into the current site */}
            <motion.p
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
              viewport={{ once: true }}
              transition={{ duration: 0.5, delay: 0.6 }}
              className="mt-8 text-sm text-[#999999] leading-relaxed"
            >
              <Link href="/verified" className="text-[#D4A853] underline underline-offset-4 hover:text-[#E8C46A] transition-colors">
                Verified sources
              </Link>
              {" — reviews, public code and competition results, each checkable at origin. Or read the "}
              <Link href="/about" className="text-[#D4A853] underline underline-offset-4 hover:text-[#E8C46A] transition-colors">
                full background
              </Link>
              {"."}
            </motion.p>

...
const footerSocials = [
  { label: "GitHub", href: "https://github.com/vkarasovpm-dotcom", icon: githubIcon },
  { label: "LinkedIn", href: "https://www.linkedin.com/in/vitaliikarasov/", icon: linkedinIcon },
  { label: "Upwork", href: "https://www.upwork.com/freelancers/~01af851972931ea5c2", icon: upworkIcon },
];
    ...
    <>
      <section id="contact" className="py-12 md:py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            15 minutes. I&apos;ll tell you what&apos;s leaking and what it would take to fix it.
          </motion.p>
          ...
          {/* Telegram */}
          <motion.a
            href="https://t.me/karvitalii"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2.5 text-[#888888] hover:text-[#D4A853] transition-colors duration-200"
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
          ...
          <div className="flex flex-wrap items-center justify-center gap-5 md:gap-6 order-1 md:order-2">
            {footerSocials.map((s) => (
              <a
                ...
                rel="noopener noreferrer"
                aria-label={s.label}
                className="text-[#555555] hover:text-[#D4A853] transition-colors duration-200"
              >
                {s.icon}
              </a>
            ))}

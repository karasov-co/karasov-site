...
const cases: WorkCardData[] = [
  ...
  },
  {
    ...
    intro:
      "Not construction - but this is the engineering depth behind your system. Built solo in 7 days. AI Agent Olympics prize winner - Milan AI Week 2026, Europe's largest AI event.",
    description:
